...
// допустимых значений, а не на самый большой: смысл отката — не разрешить
// более тяжёлую картинку, чем нужно, если фронт прислал не то, чего ждёт
// сервер, а не молча выдать лучшее качество.
