...
// Тег body ищем с атрибутами: страницы сайта их дописывают (лента —
// <body class="nw-body">), а точный поиск "<body>" промахивался бы молча,
// и панель открывалась бы без навигации между разделами.
