...
(function (root) {
  ...
  // Идентификатор сменился вместе с призами: счётчик показов окна ведётся
  // ПО id (shouldShowPopup -> seenRec), и под старым именем окно не всплыло
  // бы у тех, кто уже видел розыгрыш одного магнита. Призов теперь два —
  // это новость, ради которой их стоит показать заново.
  var HOUSE_GIVEAWAY = {
