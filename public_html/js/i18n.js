...
(function (root) {
  ...
  var STRINGS = {
    ru: {
      ...
      "calc.title":             "Калькулятор трейдов",
      "calc.subtitle":          "Соберите обе стороны сделки — калькулятор покажет, выгодна ли она",
      ...
      "calc.emptySide":         "Пока пусто — добавьте предметы",
      "calc.total":             "Итого",
    ...
    en: {
      ...
      "calc.subtitle":          "Build both sides of a trade and see whether it's worth it",
      ...
      "calc.emptySide":         "Empty — add some items",
      "calc.total":             "Total",
