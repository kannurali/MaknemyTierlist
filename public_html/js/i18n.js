...
(function (root) {
  ...
  var STRINGS = {
    ru: {
      ...
      "chat.with":              "Чат с",
      "chat.peerProfile":       "Профиль игрока",
      "chat.emoji":             "Смайлики",
      "chat.stickers":          "Стикеры",
      "chat.sticker":           "Стикер",
      "chat.stickerSend":       "Отправить стикер",
      "chat.stickerSearch":     "Найти предмет…",
      "chat.stickerSearchLabel": "Поиск предмета",
      "chat.stickerLoading":    "Загружаем предметы…",
      "chat.stickerNone":       "Ничего не нашлось",
      "chat.stickerError":      "Не удалось загрузить предметы",
      "chat.you":               "вы",
      "chat.login":             "Войдите через Roblox, чтобы переписываться",
      "chat.pick":              "Выберите диалог слева",
      "chat.noThreads":         "Диалогов пока нет",
      "chat.noMessages":        "Сообщений пока нет — напишите первым",
      "chat.notReady":          "Чаты ещё не подключены",
      "chat.error":             "Не удалось загрузить чаты. Попробуйте обновить страницу.",
      "chat.inputLabel":        "Сообщение",
      "chat.placeholder":       "Напишите сообщение…",
      "chat.send":              "Отправить",
      "chat.sendFailed":        "Сообщение не отправилось. Попробуйте ещё раз.",
      "chat.tooFast":           "Слишком часто. Подождите немного.",
      "chat.showList":          "Показать список диалогов",
      "chat.hideList":          "Скрыть список диалогов",
      "chat.review":            "Отзыв",
      "chat.reviewLabel":       "Текст отзыва",
      "chat.reviewPlaceholder": "Как прошла сделка?",
      "chat.reviewSend":        "Отправить",
      "chat.reviewSaved":       "Отзыв сохранён",
      "chat.reviewFailed":      "Отзыв не сохранился",
      "chat.stars":             "Оценка",
      "chat.pickStars":         "Поставьте оценку",
      "chat.status.online":     "в сети",
      "chat.status.offline":    "не в сети",
      "chat.notify":            "Уведомления в Telegram",
      "chat.notifyIntro":       "Бот в Telegram сообщит, кто вам написал (сам текст останется на сайте), а ещё — об изменениях цен и новостях. Что присылать, выбирается в профиле.",
      "chat.notifyConnect":     "Подключить Telegram",
      "chat.notifyWait":        "Нажмите «Start» в Telegram — и уведомления включатся.",
      "chat.notifyLinked":      "Уведомления приходят в Telegram",
      "chat.notifyMod":         "Сюда же приходят новые обращения в поддержку.",
      "chat.notifyOff":         "Отключить",
      "chat.notifyFailed":      "Не получилось. Попробуйте ещё раз.",
      "chat.delete":            "Удалить чат у себя",
      "chat.deleteConfirm":     "Удалить чат с {nick}? Переписка пропадёт только у вас, у собеседника она останется.",
      "chat.deleteFailed":      "Не удалось удалить чат. Попробуйте ещё раз.",

      "trade.title":            "Трейдинг",
      "trade.toolsLabel":       "Действия",
      "trade.toolPrices":       "Уточнить цены",
      "trade.toolCreate":       "Создать",
      "trade.toolSupport":      "Поддержка",
      "trade.searchLabel":      "Поиск по предметам и никам",
      "trade.searchPlaceholder": "Предмет или ник…",
      "trade.searchGo":         "Искать",
      "trade.feedLabel":        "Объявления",
      "trade.mineTitle":        "Ваши объявления",
      "trade.allTitle":         "Все объявления",
      "trade.more":             "Показать ещё",
      "trade.loading":          "Загружаем объявления…",
      "trade.loadError":        "Не удалось загрузить объявления. Попробуйте обновить страницу.",
      "trade.notReady":         "Трейдинг скоро откроется",
      "trade.empty":            "Объявлений пока нет — создайте первое!",
      "trade.noResults":        "По запросу «{q}» ничего не нашлось",
      "trade.give":             "Отдаёт",
      "trade.want":             "Хочет",
      "trade.anyOffer":         "Жду предложений",
      "trade.write":            "Написать",
      "trade.loginToWrite":     "Войти, чтобы написать",
      "trade.profile":          "Профиль автора",
      "trade.done":             "Сделка состоялась",
      "trade.cancel":           "Снять",
      "trade.remove":           "Удалить",
      "trade.confirmDone":      "Отметить сделку как состоявшуюся? Объявление уйдёт из ленты, а сделка попадёт в ваш профиль.",
      "trade.confirmCancel":    "Снять объявление с ленты?",
      "trade.confirmRemove":    "Удалить это объявление как модератор?",
      "trade.closeFailed":      "Не получилось. Попробуйте ещё раз.",
      "trade.likes":            "Положительных отзывов: {n}",
      "trade.dislikes":         "Отрицательных отзывов: {n}",
      "trade.agoNow":           "только что",
      "trade.agoMin":           "{n} мин назад",
      "trade.agoHour":          "{n} ч назад",
      "trade.agoDay":           "{n} дн назад",
      "trade.itemMissing":      "Предмет убран из тирлиста",
      "trade.draft":            "Привет! Пишу по твоему объявлению на Maknemy: ты отдаёшь {give} и хочешь {want}. Актуально?",
      "trade.draftAny":         "Привет! Пишу по твоему объявлению на Maknemy: ты отдаёшь {give}. Могу предложить обмен — актуально?",
      "trade.meLabel":          "Ваш профиль",
      "trade.meNick":           "Ник",
      "trade.meId":             "ID",
      "trade.meProfile":        "Профиль",
      "trade.meLogin":          "Войти",
      "trade.giveLabel":        "Вы предлагаете",
      "trade.wantLabel":        "Вы хотите",
      "trade.givePill":         "Вы предлагаете",
      "trade.wantPill":         "Вы хотите",
      "trade.publish":          "Опубликовать",
      "trade.publishLogin":     "Войти и опубликовать",
      "trade.publishSoon":      "Публикация скоро откроется",
      "trade.publishing":       "Публикуем…",
      "trade.hintEmpty":        "Добавьте в «Вы предлагаете» хотя бы один предмет",
      "trade.hintAny":          "«Вы хотите» можно оставить пустым — тогда это «жду предложений»",
      "trade.hintLogin":        "Публиковать можно после входа через Roblox — собранное сохранится",
      "trade.errBadItems":      "Список предметов обновился — проверьте объявление ещё раз",
      "trade.errNotReady":      "Трейдинг ещё не подключён",
      "trade.errRate":          "Слишком часто. Подождите немного.",
      "trade.errFailed":        "Не удалось опубликовать. Попробуйте ещё раз.",
      "trade.posted":           "Объявление опубликовано!",
      "trade.stateOpen":        "В ленте",
      "trade.stateExpired":     "Истекло",
      "trade.stateDone":        "Сделка состоялась",
      "trade.stateCancelled":   "Снято",
      "trade.stateRemoved":     "Удалено модератором",
      "trade.expiresQuiet":     "Исчезнет через {t}, если никто не напишет",
      "trade.replied":          "Вам написали — в ленте ещё {t}",
      "trade.repost":           "Выложить снова",
      "trade.durDay":           "{n} дн",
      "trade.durHour":          "{n} ч",
      "trade.durMin":           "{n} мин",
      "trade.quotaLeft":        "Активных объявлений: {active} из {activeMax}. За 5 часов можно выложить ещё {n}",
      "trade.activeOut":        "У вас уже {max} активных объявлений — снимите одно или отметьте сделку, и можно будет выложить новое",
      "trade.quotaOut":         "Лимит — {max} объявлений за 5 часов. Следующее можно через {t}",
      "profile.tradesTitle":    "Мои объявления",
      "profile.tradesEmpty":    "Вы ещё не публиковали объявлений",
      "profile.tradesPeerTitle": "Объявления игрока",
      "profile.tradesPeerEmpty": "Сейчас у игрока нет активных объявлений",
      "trade.warnTitle":        "Мы боремся за вашу безопасность во время торговли",
      "trade.warnP1a":          "Пожалуйста,",
      "trade.warnP1b":          "остерегайтесь подозрительных предложений",
      "trade.warnP1c":          "и по возможности",
      "trade.warnP1d":          "не вступайте в диалоги с посредниками,",
      "trade.warnP1e":          "а ведите диалог напрямую с тем, кто предлагает вам свой оффер",
      "trade.warnP2a":          "Если увидели недобросовестного трейдера, обязательно сообщите нам",
      "trade.warnP2b":          "в поддержку!",
      "trade.warnSign":         "С любовью Maknemy",
      "support.title":          "Центр обращений",
      "support.lead1a":         "Перед обращением просим",
      "support.lead1b":         "соблюдать вежливость",
      "support.lead1c":         "к персоналу и",
      "support.lead1d":         "не нести ложную информацию.",
      "support.lead2a":         "Подробно опишите свою проблему, и мы оперативно поможем вам с",
      "support.lead2b":         "её решением!",
      "support.label":          "Опишите свою проблему",
      "support.placeholder":    "Опишите свою проблему…",
      "support.send":           "Отправить",
      "support.sending":        "Отправляем…",
      "support.direct":         "Написать лично",
      "support.login":          "Войти и написать",
      "support.loginHint":      "Ответ придёт в личный чат на сайте, поэтому писать можно после входа через Roblox. Или напишите нам лично в Telegram.",
      "support.closed":         "Центр обращений откроется вместе со входом через Roblox. Пока напишите нам лично в Telegram.",
      "support.tooShort":       "Опишите проблему чуть подробнее — хотя бы {n} символов",
      "support.failed":         "Не удалось отправить. Попробуйте ещё раз.",
      "support.notReady":       "Центр обращений ещё не подключён — напишите нам лично",
      "support.rate":           "Слишком много обращений. Попробуйте позже.",
      "support.close":          "Закрыть",
      "support.thanksTitle":    "Спасибо за ваше доверие",
      "support.thanksText":     "В ближайшее время мы решим вашу проблему!",
      "support.thanksSign":     "С любовью",
      ...
      "profile.menuLabel":      "Действия с аккаунтом",
      "profile.menuChats":      "Чаты",
      "profile.menuHelp":       "Помощь",
      "profile.menuLogout":     "Выйти из аккаунта",
      "profile.menuSwitch":     "Сменить аккаунт",
      "profile.menuDelete":     "Удалить аккаунт",
      "profile.menuCollapse":   "Свернуть меню профиля",
      "profile.menuExpand":     "Развернуть меню профиля",

      "profile.ownerTitle":     "Обо мне и проекте Maknemy",
      "profile.ownerP1":        "Меня зовут Максим, но в интернете я известен как Maknemy. Я Roblox-креатор, блогер и дизайнер, специализирующийся на игре Blox Fruits.",
      "profile.ownerP2":        "Я создаю новости, обзоры обновлений, тирлисты, гайды, теории и материалы об игровой экономике и трейдах. Моя цель — не просто рассказывать о происходящем в игре, а помогать игрокам разбираться в предметах, принимать более выгодные решения и всегда оставаться в курсе важных событий.",
      "profile.ownerP3":        "Maknemy.com — мой главный проект и независимый фанатский сайт для игроков Blox Fruits. Он создан как удобное место, где собраны самые необходимые инструменты и информация для игры:",
      "profile.ownerList1":     "актуальный тирлист предметов",
      "profile.ownerList2":     "калькулятор трейдов",
      "profile.ownerList3":     "цены и оценки фруктов, перманентов, геймпассов, скинов и мутаций",
      "profile.ownerList4":     "новости и обновления Blox Fruits",
      "profile.ownerList5":     "полезные материалы для игроков",
      "profile.ownerList6":     "информация об игровой экономике и изменениях цен",
      "profile.ownerP4":        "Сайт помогает игрокам оценивать стоимость предметов, проверять выгодность трейдов и следить за изменениями экономики после обновлений. Проект развивается вместе с игрой и создаётся прежде всего для русскоязычного сообщества и игроков из СНГ.",
      "profile.ownerP5":        "Моя цель — сделать maknemy.com самым полезным и удобным фанатским проектом по Blox Fruits: местом, куда игроки заходят перед трейдом, после обновления и просто для поиска актуальной информации об игре.",

      "profile.ownerSocial":    "Соцсети",
      "profile.ownerYoutube":   "YouTube",
      "profile.ownerTiktok":    "TikTok",
      "profile.ownerTwitch":    "Twitch",
      "profile.ownerX":         "X (Twitter)",
      "profile.ownerTg1":       "@maknemy",
      "profile.ownerTg2":       "@mksvtn",

      "profile.ownerTgTitle":   "Telegram-проекты",
      "profile.ownerTgMain":    "Основной канал",
      "profile.ownerTgTierlist": "Maknemy Tierlist",
      "profile.ownerTgChat":    "Чат подписчиков",

      "profile.aboutTitle":     "О себе",
      "profile.aboutTitlePeer": "Об игроке",
      "profile.write":          "Написать",
      "profile.notifyIntro":    "Подключите Telegram — бот напишет, когда вам ответят в чате, а ещё об изменениях цен в тирлисте и новостях.",
      "profile.notifyTopics":   "Что ещё присылать",
      "profile.notifyPrices":   "Изменения цен в тирлисте",
      "profile.notifyNews":     "Новости",
      "profile.notifySaveError": "Не сохранилось — попробуйте ещё раз",
      ...
      "profile.aboutError":     "Не удалось сохранить",
      "profile.aboutTooOften":  "Слишком часто — попробуйте позже",
      "profile.aboutUnavailable": "Пока не сохраняется — раздел ещё не подключён",

      "profile.chartTitle":     "Сделки по дням",
      "profile.chartOk":        "Успешно",
      "profile.chartFail":      "Отказ",
      "profile.chartSum":       "Оборот",
      "profile.chartDay":       "День",
      "profile.chartMonth":     "Месяц",
      ...
      "news.fieldTitleEn":      "Заголовок (EN, необязательно — пустой переведётся сам)",
      ...
      "news.publishing":        "Перевод и сохранение…",
      "news.enAutoHint":        "Пустой английский текст переведётся автоматически при публикации",
      "news.translateFailed":   "Пост сохранён, но автоперевод на английский не получился: англоязычные читатели пока видят русский текст. Позже откройте пост и нажмите «Опубликовать» ещё раз.",
    ...
    en: {
      ...
      "chat.with":              "Chat with",
      "chat.peerProfile":       "Player profile",
      "chat.emoji":             "Emoji",
      "chat.stickers":          "Stickers",
      "chat.sticker":           "Sticker",
      "chat.stickerSend":       "Send sticker",
      "chat.stickerSearch":     "Find an item…",
      "chat.stickerSearchLabel": "Search items",
      "chat.stickerLoading":    "Loading items…",
      "chat.stickerNone":       "Nothing found",
      "chat.stickerError":      "Could not load the items",
      "chat.you":               "you",
      "chat.login":             "Log in with Roblox to start chatting",
      "chat.pick":              "Pick a conversation on the left",
      "chat.noThreads":         "No conversations yet",
      "chat.noMessages":        "No messages yet — write first",
      "chat.notReady":          "Chats are not switched on yet",
      "chat.error":             "Could not load the chats. Try reloading the page.",
      "chat.inputLabel":        "Message",
      "chat.placeholder":       "Write a message…",
      "chat.send":              "Send",
      "chat.sendFailed":        "The message did not go through. Try again.",
      "chat.tooFast":           "Too fast. Wait a moment.",
      "chat.showList":          "Show conversation list",
      "chat.hideList":          "Hide conversation list",
      "chat.review":            "Review",
      "chat.reviewLabel":       "Review text",
      "chat.reviewPlaceholder": "How did the trade go?",
      "chat.reviewSend":        "Send",
      "chat.reviewSaved":       "Review saved",
      "chat.reviewFailed":      "Review was not saved",
      "chat.stars":             "Rating",
      "chat.pickStars":         "Pick a rating",
      "chat.status.online":     "online",
      "chat.status.offline":    "offline",
      "chat.notify":            "Telegram notifications",
      "chat.notifyIntro":       "Our Telegram bot will tell you who messaged you (the message itself stays on the site), plus tier list price changes and news. Choose what to receive on your profile.",
      "chat.notifyConnect":     "Connect Telegram",
      "chat.notifyWait":        "Press “Start” in Telegram to turn notifications on.",
      "chat.notifyLinked":      "Notifications go to Telegram",
      "chat.notifyMod":         "New support requests come here too.",
      "chat.notifyOff":         "Turn off",
      "chat.notifyFailed":      "Something went wrong. Try again.",
      "chat.delete":            "Delete chat for me",
      "chat.deleteConfirm":     "Delete the chat with {nick}? It disappears only for you; the other person keeps it.",
      "chat.deleteFailed":      "Could not delete the chat. Try again.",

      "trade.title":            "Trading",
      "trade.toolsLabel":       "Actions",
      "trade.toolPrices":       "Check prices",
      "trade.toolCreate":       "Create",
      "trade.toolSupport":      "Support",
      "trade.searchLabel":      "Search items and nicknames",
      "trade.searchPlaceholder": "Item or nickname…",
      "trade.searchGo":         "Search",
      "trade.feedLabel":        "Offers",
      "trade.mineTitle":        "Your offers",
      "trade.allTitle":         "All offers",
      "trade.more":             "Show more",
      "trade.loading":          "Loading offers…",
      "trade.loadError":        "Could not load the offers. Try reloading the page.",
      "trade.notReady":         "Trading opens soon",
      "trade.empty":            "No offers yet — post the first one!",
      "trade.noResults":        "Nothing found for “{q}”",
      "trade.give":             "Gives",
      "trade.want":             "Wants",
      "trade.anyOffer":         "Open to offers",
      "trade.write":            "Message",
      "trade.loginToWrite":     "Log in to message",
      "trade.profile":          "Author's profile",
      "trade.done":             "Trade done",
      "trade.cancel":           "Take down",
      "trade.remove":           "Remove",
      "trade.confirmDone":      "Mark the trade as done? The offer leaves the feed and the trade goes to your profile.",
      "trade.confirmCancel":    "Take the offer down?",
      "trade.confirmRemove":    "Remove this offer as a moderator?",
      "trade.closeFailed":      "That did not work. Try again.",
      "trade.likes":            "Positive reviews: {n}",
      "trade.dislikes":         "Negative reviews: {n}",
      "trade.agoNow":           "just now",
      "trade.agoMin":           "{n} min ago",
      "trade.agoHour":          "{n} h ago",
      "trade.agoDay":           "{n} d ago",
      "trade.itemMissing":      "Item removed from the tier list",
      "trade.draft":            "Hi! Writing about your offer on Maknemy: you give {give} and want {want}. Still up?",
      "trade.draftAny":         "Hi! Writing about your offer on Maknemy: you give {give}. I can offer a trade — still up?",
      "trade.meLabel":          "Your profile",
      "trade.meNick":           "Nick",
      "trade.meId":             "ID",
      "trade.meProfile":        "Profile",
      "trade.meLogin":          "Log in",
      "trade.giveLabel":        "You offer",
      "trade.wantLabel":        "You want",
      "trade.givePill":         "You offer",
      "trade.wantPill":         "You want",
      "trade.publish":          "Publish",
      "trade.publishLogin":     "Log in and publish",
      "trade.publishSoon":      "Publishing opens soon",
      "trade.publishing":       "Publishing…",
      "trade.hintEmpty":        "Add at least one item to “You offer”",
      "trade.hintAny":          "You can leave “You want” empty — it then reads “open to offers”",
      "trade.hintLogin":        "You can publish after logging in with Roblox — your offer will be kept",
      "trade.errBadItems":      "The item list has changed — check your offer again",
      "trade.errNotReady":      "Trading is not switched on yet",
      "trade.errRate":          "Too often. Wait a little.",
      "trade.errFailed":        "Could not publish. Try again.",
      "trade.posted":           "Your offer is live!",
      "trade.stateOpen":        "In the feed",
      "trade.stateExpired":     "Expired",
      "trade.stateDone":        "Trade done",
      "trade.stateCancelled":   "Taken down",
      "trade.stateRemoved":     "Removed by a moderator",
      "trade.expiresQuiet":     "Disappears in {t} if nobody writes",
      "trade.replied":          "Someone wrote — stays for {t} more",
      "trade.repost":           "Post again",
      "trade.durDay":           "{n} d",
      "trade.durHour":          "{n} h",
      "trade.durMin":           "{n} min",
      "trade.quotaLeft":        "Active offers: {active} of {activeMax}. You can post {n} more within 5 hours",
      "trade.activeOut":        "You already have {max} active offers — take one down or mark a trade done to post a new one",
      "trade.quotaOut":         "Limit: {max} offers per 5 hours. Next one in {t}",
      "profile.tradesTitle":    "My offers",
      "profile.tradesEmpty":    "You have not posted any offers yet",
      "profile.tradesPeerTitle": "Player's offers",
      "profile.tradesPeerEmpty": "This player has no active offers right now",
      "trade.warnTitle":        "We fight for your safety while you trade",
      "trade.warnP1a":          "Please",
      "trade.warnP1b":          "watch out for suspicious offers",
      "trade.warnP1c":          "and whenever possible",
      "trade.warnP1d":          "avoid middlemen —",
      "trade.warnP1e":          "talk directly to the person who made you the offer",
      "trade.warnP2a":          "If you spot a dishonest trader, be sure to tell us",
      "trade.warnP2b":          "via support!",
      "trade.warnSign":         "With love, Maknemy",
      "support.title":          "Support center",
      "support.lead1a":         "Before you write, please",
      "support.lead1b":         "be polite",
      "support.lead1c":         "to our staff and",
      "support.lead1d":         "do not report anything false.",
      "support.lead2a":         "Describe your problem in detail and we will quickly help you",
      "support.lead2b":         "solve it!",
      "support.label":          "Describe your problem",
      "support.placeholder":    "Describe your problem…",
      "support.send":           "Send",
      "support.sending":        "Sending…",
      "support.direct":         "Write directly",
      "support.login":          "Log in to write",
      "support.loginHint":      "The reply comes to your chat on the site, so please log in with Roblox first. Or message us directly on Telegram.",
      "support.closed":         "The support center opens together with Roblox login. For now, message us directly on Telegram.",
      "support.tooShort":       "Describe the problem in a bit more detail — at least {n} characters",
      "support.failed":         "Could not send. Try again.",
      "support.notReady":       "The support center is not switched on yet — message us directly",
      "support.rate":           "Too many requests. Try again later.",
      "support.close":          "Close",
      "support.thanksTitle":    "Thank you for your trust",
      "support.thanksText":     "We will solve your problem soon!",
      "support.thanksSign":     "With love,",
      ...
      "profile.menuLabel":      "Account actions",
      "profile.menuChats":      "Chats",
      "profile.menuHelp":       "Help",
      "profile.menuLogout":     "Log out",
      "profile.menuSwitch":     "Switch account",
      "profile.menuDelete":     "Delete account",
      "profile.menuCollapse":   "Collapse profile menu",
      "profile.menuExpand":     "Expand profile menu",

      "profile.ownerTitle":     "About me and the Maknemy project",
      "profile.ownerP1":        "My name is Maksim, known online as Maknemy. I'm a Roblox creator, blogger and designer focused on Blox Fruits.",
      "profile.ownerP2":        "I make news, update reviews, tier lists, guides, theories and material about the in-game economy and trading. My goal isn't just to report what's happening in the game, but to help players understand items, make better decisions and stay on top of everything that matters.",
      "profile.ownerP3":        "Maknemy.com is my main project — an independent fan site for Blox Fruits players. It's built as one convenient place that brings together the tools and information players need most:",
      "profile.ownerList1":     "an up-to-date item tier list",
      "profile.ownerList2":     "a trade calculator",
      "profile.ownerList3":     "values for fruits, permanent fruits, gamepasses, skins and mutations",
      "profile.ownerList4":     "Blox Fruits news and updates",
      "profile.ownerList5":     "useful material for players",
      "profile.ownerList6":     "information about the game's economy and price changes",
      "profile.ownerP4":        "The site helps players judge item values, check whether a trade is worth making, and track how the economy shifts after updates. The project grows alongside the game and is built first and foremost for the Russian-speaking community and players from the CIS.",
      "profile.ownerP5":        "My goal is to make maknemy.com the most useful and convenient Blox Fruits fan project out there — a place players open before a trade, right after an update, or whenever they just need current information about the game.",

      "profile.ownerSocial":    "Social media",
      "profile.ownerYoutube":   "YouTube",
      "profile.ownerTiktok":    "TikTok",
      "profile.ownerTwitch":    "Twitch",
      "profile.ownerX":         "X (Twitter)",
      ...
      "profile.ownerTgTitle":   "Telegram projects",
      "profile.ownerTgMain":    "Main channel",
      "profile.ownerTgTierlist": "Maknemy Tierlist",
      "profile.ownerTgChat":    "Subscriber chat",

      "profile.aboutTitle":     "About",
      "profile.aboutTitlePeer": "About the player",
      "profile.write":          "Message",
      "profile.notifyIntro":    "Connect Telegram and the bot will let you know when someone replies in the chat, plus tier list price changes and news.",
      "profile.notifyTopics":   "Also send me",
      "profile.notifyPrices":   "Tier list price changes",
      "profile.notifyNews":     "News",
      "profile.notifySaveError": "Not saved — please try again",
      ...
      "profile.aboutError":     "Could not save",
      "profile.aboutTooOften":  "Too often — try again later",
      "profile.aboutUnavailable": "Not saving yet — the section is not wired up",

      "profile.chartTitle":     "Trades by day",
      "profile.chartOk":        "Successful",
      "profile.chartFail":      "Declined",
      "profile.chartSum":       "Turnover",
      "profile.chartDay":       "Day",
      "profile.chartMonth":     "Month",
      ...
      "news.fieldTitleEn":      "Title (EN, optional — auto-translated if left empty)",
      ...
      "news.publishing":        "Translating and saving…",
      "news.enAutoHint":        "Empty English text is translated automatically on publish",
      "news.translateFailed":   "The post is saved, but the automatic English translation failed: English readers see the Russian text for now. Open the post later and press “Publish” again.",
