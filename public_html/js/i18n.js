...
(function (root) {
  ...
  var STRINGS = {
    ru: {
      ...
      "chat.notifyIntro":       "Бот в Telegram сообщит, кто вам написал. Сам текст останется на сайте.",
    ...
    en: {
      ...
      "chat.notifyIntro":       "Our Telegram bot will tell you who messaged you. The message itself stays on the site.",
