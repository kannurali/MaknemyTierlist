      ...
      <ul class="mk-nav">
        ...
        <li>
          <!-- Раздела ещё нет, но у "не туда" появился честный адрес: клик
               ...
               как было раньше (см. соседнюю карточку .hm-card «Фрукты» ниже —
               у неё своей страницы по-прежнему нет, и она остаётся span). -->
...
<main class="hm">
  ...
  <section class="hm-lead">
    ...
    <div class="hm-cards hm-anim">
      <ul class="hm-cards-row">
        <li>
          <div class="hm-card" aria-disabled="true" title="Раздел в разработке">
  ...
  <section class="hm-faq">
    <div class="hm-faq-inner">
      ...
      <!-- Ответов в макете нет — заливаются позже. Механика раскрытия уже
           рабочая, поэтому подмена текста не потребует правок js. -->
      <ul class="hm-faq-list">
        <li class="hm-faq-item">
          <button class="hm-faq-q" type="button" aria-expanded="false">Как работает тир лист?</button>
          <div class="hm-faq-a">Ответ скоро появится.</div>
        </li>
        <li class="hm-faq-item">
          <button class="hm-faq-q" type="button" aria-expanded="false">Стоит ли верить тир листам?</button>
          <div class="hm-faq-a">Ответ скоро появится.</div>
        </li>
        <li class="hm-faq-item">
          <button class="hm-faq-q" type="button" aria-expanded="false">Как начать трейдиться себе в плюс?</button>
          <div class="hm-faq-a">Ответ скоро появится.</div>
        </li>
        <li class="hm-faq-item">
          <button class="hm-faq-q" type="button" aria-expanded="false">Какие фрукты актуальны в этом месяце?</button>
          <div class="hm-faq-a">Ответ скоро появится.</div>
        </li>
        <li class="hm-faq-item">
          <button class="hm-faq-q" type="button" aria-expanded="false">Как создается тир лист?</button>
          <div class="hm-faq-a">Ответ скоро появится.</div>
        </li>
        <li class="hm-faq-item">
          <button class="hm-faq-q" type="button" aria-expanded="false">Почему именно ты можешь стать успешным в трейдинге?</button>
          <div class="hm-faq-a">Ответ скоро появится.</div>
        </li>
      </ul>
    </div>
