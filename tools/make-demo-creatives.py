...
def strip_static():
    ...
    text_at(d, (56, 58), "PLAYEROK", font(FONT_BOLD, 76), INK)
...
def rail():
    ...
    text_at(d, (160, 104), "PLAYEROK", font(FONT_BOLD, 46), INK, anchor="mm")
...
def dock():
    ...
    text_at(d, (30, 34), "PLAYEROK", font(FONT_BOLD, 50), INK)
...
def popup():
    ...
    text_at(d, (400, 128), "PLAYEROK", font(FONT_BOLD, 66), INK, anchor="mm")
