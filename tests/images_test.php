...
test('save_image_bytes honours an explicit max side', function () {
    ...
    // Пятым аргументом, а не четвёртым: ветки рекламы и новостей независимо
    // добавили сюда по параметру, и после слияния $maxSide встал за $allow.
    $url = save_image_bytes($bytes, $dir, 512000, ['png', 'jpg', 'webp'], 1280);
