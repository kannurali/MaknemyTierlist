...
- Версии: `styles.css` 56 → 57, `app.js` 73 → 74, `i18n.js` 41 → 45 на `index.php`, `news.php`, `home.php`, `calculator.php` (44 уже занят открытым PR #70).
